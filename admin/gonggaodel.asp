...
<title>无标题文档</title>
<link href="../inc/Style.css" rel="stylesheet"></head>
...
<table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
        ...
        <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" height="25">
          <td width="231" align="right"><strong>公告时间</strong>：&nbsp;</td>
          <td width="763" align="left"><span class="manager_black_font_12px">&nbsp;&nbsp;<%=rs("date")%></span></td>
        </tr>
        <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" height="25">
          <td colspan="2" align="center"><input type="button" value="删 除" onClick="location.href('gonggaodelcheck.asp?id=<%=trim(request.QueryString("id"))%>');" class="logbutton">            &nbsp;<span class="manager_black_font_12px">&nbsp;&nbsp;
