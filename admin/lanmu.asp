...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="topbg">
    <td height="22" colspan="2"  align="center"><strong>栏目管理</strong></td>
  </tr>
  <tr class="tdbg">
    <td width="70" height="30" ><strong>管理导航：</strong></td>
    <td>&nbsp;<a href="lanmu.asp">栏目首页</a>&nbsp;|&nbsp;<a href=lunmuadd.asp class="manager_link_3">添加栏目</a>&nbsp;|</td>
  </tr>
</table>
...
<table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
  <tr class="title" height="22">
    ...
    <td width="463" align="center" ><strong>栏目名称</strong></td>
    <td width="74" align="center" ><strong>栏目序号</strong></td>

    <td width="184" align="center" ><strong>操作</strong></td>
  </tr>
            <% on error resume next
     set rs=server.createobject("adodb.recordset")
	sql="select * from lanmu order by id desc"
...
%>
  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" height="25">
    ...
    <td>&nbsp;&nbsp;<a href="../Newscenter_list.asp?newsid=<%=rs("newsid")%>" target="_blank" class="manager_link_2"><%=rs("lanmu")%></a></td>
    <td width="74" align="center"><%=rs("lanmuid")%></td>

    <td width="184" align="center"><a href="lanmuedit.asp?id=<%=rs("id")%>" class="manager_link_2">[修改]</a> <a href="lanmudel.asp?id=<%=rs("id")%>" class="manager_link_2">[删除]</a>
	</td>
  </tr>
<%
	rs.MoveNext()
