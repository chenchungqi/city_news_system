...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="topbg">
    <td height="22" colspan="2"  align="center"><strong>公告管理</strong></td>
  </tr>
  <tr class="tdbg">
    <td width="70" height="30" ><strong>管理导航：</strong></td>
    <td>&nbsp;<a href="gonggao.asp">公告首页</a>&nbsp;|&nbsp;<a href=gonggaoadd.asp class="manager_link_3">添加公告</a>&nbsp;|</td>
  </tr>
</table>
...
<table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
  <tr class="title" height="22">
    ...
    <td width="74" align="center" ><strong>日期</strong></td>
...
%>
  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" height="25">
    ...
    <td width="184" align="center"><a href="gonggaoedit.asp?id=<%=rs("id")%>" class="manager_link_2">[修改]</a> <a href="gonggaodel.asp?id=<%=rs("id")%>" class="manager_link_2">[删除]</a>
	</td>
  </tr>
<%
	rs.MoveNext()
