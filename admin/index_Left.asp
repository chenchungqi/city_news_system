...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
        <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background=../images/title_bg_quit.gif id=menuTitle0> 
          <span><a href="kaifa.asp" target=main><b>管理首页</b></a> | <a href="../LoginExit.asp" target="_top"><b>安全退出</b></a></span> 
        </td>
  </tr>
  <tr>
...
<tr>
  <td height=20><a href=ManagerAdd.asp target=main>添加管理员</a></td>
</tr>

<tr>
  <td height=20><a href="ManagerList.asp" target=main>管理员管理</a></td>
</tr>
<tr>
  <td height=20><a href="ManagerPInfoEdit.asp" target=main>修改个人信息</a> | <a href="ManagerPInfo.asp" target=main>管理</a></td>
</tr>
</table>
</div>
<div  style="width:158">
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
    <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="../images/Admin_left_1.gif" id=menuTitle2 onClick="showsubmenu(2)" style="cursor:hand;"><span>新闻管理</span> </td>
  </tr>
  <tr>
    <td style="display:" id='submenu2'><div class=sec_menu style="width:158">
      <table cellpadding=0 cellspacing=0 align=center width=130>
        <tr>
          <td height=20><a href="NewsAdd.asp" target="main">添加新闻</a></td>
        </tr>
        <tr>
          <td height=20><a href="news.asp" target=main>新闻管理</a></td>
        </tr>
...
<div class=sec_menu style="width:158">
            <table cellpadding=0 cellspacing=0 align=center width=130>
              ...
              <tr>
                <td height=20><a href="gonggaoadd.asp" target=main>添加公告</a></td>
              </tr>
              <tr>
                <td height=20><a href="gonggao.asp" target=main>公告管理</a></td>
              </tr>
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
        <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="../images/Admin_left_7.gif" id=menuTitle10 onClick="showsubmenu(10)" style="cursor:hand;"> 
          <span>友情链接管理</span> </td>
  </tr>
  <tr>
              ...
              <tr>
                <td height=20><p><br>
                 &nbsp;版权所有：&nbsp;<a  target="_blank" href="#"><font color="#FF0000">计算分院</font></a><br>
                  &nbsp;设计制作：&nbsp;<a  href="mailto:yuxy@zucc.edu.cn">yuxueyong</a><BR>
                  &nbsp;技术支持：&nbsp;<a  target="_blank" href="http://www.yuxueyong.com">by
                  zucc&amp;yxy</a><br>
                  <br>
                </p></td>
              </tr>
